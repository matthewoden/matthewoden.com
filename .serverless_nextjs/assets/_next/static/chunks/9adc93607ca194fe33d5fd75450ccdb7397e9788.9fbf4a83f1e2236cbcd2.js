  ...
  [2],
  {
    ...
    Nh2W: function (t, e, r) {
      ...
      function p() {
        ...
        return Promise.race([t, f(3800, h(new Error('Failed to load client build manifest')))])
      }
      function d(t, e) {
        return p().then(function (r) {
          if (!(e in r)) throw h(new Error('Failed to lookup route: '.concat(e)))
                  ...
                  (e = (function (t, e) {
                    return new Promise(function (r, n) {
                      ;((e = document.createElement('script')).onload = r),
                        (e.onerror = function () {
                          return n(h(new Error('Failed to load script: '.concat(t))))
                        }),
                        ...
                        switch ((n.prev = n.next)) {
                          ...
                          case 8:
                            return (
                              ...
                              Promise.race([
                                i.whenEntrypoint(r),
                                f(3800, h(new Error('Route did not complete loading: '.concat(r)))),
                              ])
                            )
                          case 13:
                            return (
        ...
        try {
          ...
          if ((0, p.isDynamicRoute)(a.pathname) && a.searchParams && r) {
            var u = (0, v.searchParamsToUrlQuery)(a.searchParams),
              ...
              l = s.result,
              h = s.params
            l && (i = (0, f.formatWithValidation)({ pathname: l, hash: a.hash, query: L(u, h) }))
          }
          ...
          i(t, [
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 18:
                              if (
                                ...
                                this._inFlightRoute &&
                                  this.abortComponentLoad(this._inFlightRoute, g),
                                (a = S(_(P(a) ? k(a) : a, i.locale, this.defaultLocale))),
                            ...
                            case 50:
                              if (
                                ((x = this._resolveHref(x, A)).pathname !== C &&
                                  ((C = x.pathname), (o = (0, f.formatWithValidation)(x))),
                                (C = C ? (0, c.removePathTrailingSlash)(k(C)) : C),
                            ...
                            case 62:
                              if (((M = b(k(M), this.locale)), !(0, p.isDynamicRoute)(N))) {
                                e.next = 78
                                break
                              }
                              if (
                              ...
                              if (
                                !(
                                  (H = Object.keys(F.groups).filter(function (t) {
                                    return !I[t]
                                  })).length > 0
                                )
                              ) {
                              ...
                              throw new Error(
                                (B
                                  ? 'The provided `href` ('
                                      ...
                                      .concat(H.join(', '), ') to be interpolated properly. ')
                            ...
                            case 78:
                              return (
                                ...
                                (e.prev = 79),
                                (e.next = 82),
                                this.getRouteInfo(N, C, I, S(_(M, this.locale)), g)
                              )
                            case 82:
                              if (
                                ((V = e.sent),
                              ...
                              if (!(Q = J.pageProps.__N_REDIRECT).startsWith('/')) {
                                e.next = 93
                                break
                              }
                              if (
                            ...
                            case 105:
                              return (
                                (e.next = 107), this.getRouteInfo(rt, rt, I, a, { shallow: !1 })
                              )
                            case 107:
                              V = e.sent
                            case 108:
                            ...
                            case 113:
                              ...
                              throw (t.events.emit('routeChangeError', X, w, g), X)
                            case 116:
                              return (
                                t.events.emit('routeChangeComplete', a, g), e.abrupt('return', !0)
                              )
                            case 121:
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 6:
                              if (
                                ((e.prev = 6), 'undefined' !== typeof l && 'undefined' !== typeof h)
                              ) {
                                e.next = 14
                                break
                              }
                              ...
                              return (
                                (h || p) &&
                                  (d = this.pageLoader.getDataHref(
                                    (0, f.formatWithValidation)({ pathname: r, query: o }),
                                    k(a),
                                    h,
                                    this.locale
                                  )),
                                ...
                                this._getData(function () {
                                  return h
                                    ...
                                    : p
                                    ? m._getServerData(d)
                                    : m.getInitialProps(l, { pathname: r, query: o, asPath: a })
                                })
                              )
                            case 21:
                              return (
              ...
              value: function (t, e) {
                ...
                return (
                  '/404' === o ||
                    ...
                    (e.includes(o) ||
                      e.some(function (e) {
                        if ((0, p.isDynamicRoute)(e) && (0, y.getRouteRegex)(e).re.test(o))
                            ...
                            case 7:
                              ;(u = t.sent),
                                (a = this._resolveHref(a, u, !1)).pathname !== i &&
                                  ((i = a.pathname), (e = (0, f.formatWithValidation)(a))),
                                (t.next = 12)
                              break
                            case 12:
                              return (
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  (e.AppTree = n),
                  (0, f.loadGetInitialProps)(r, { AppTree: n, Component: t, router: this, ctx: e })
                )
              },
            },
            {
    ...
    'g/15': function (t, e, r) {
      ...
      e.SP = h
      var f =
        h && 'function' === typeof performance.mark && 'function' === typeof performance.measure
      e.ST = f
    },
    gguc: function (t, e, r) {
      'use strict'
    ...
    qOIg: function (t, e, r) {
      ...
      var o = ((n = r('FdF9')) && n.__esModule ? n : { default: n }).default.createContext(null)
      e.RouterContext = o
    },
    sXyB: function (t, e, r) {
      var n = r('SksO'),
